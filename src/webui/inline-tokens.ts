// Single source of truth for the WebUI's constrained inline-markdown grammar.
//
// Three surfaces render the same inline syntax — the CM6 live editor
// (cm6/inline.ts), the contenteditable/table HTML bridge (markdown.tsx) and the
// TOC label stripper (cm6/chrome/toc.tsx) — and they had drifted apart. They all
// consume this tokenizer now, so the grammar can only change in one place.
//
