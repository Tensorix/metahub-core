...
const PATHS: Record<string, string> = {
  ...
  openPeek: '<rect x="3" y="5" width="18" height="14" rx="2.5"/><rect x="6" y="8" width="4" height="8" rx="1" fill="currentColor" stroke="none"/>',
  ...
  // device roster forms (settings/devices-page.tsx)
  ...
  bucket: '<path d="M3 6h18l-1.5 13a2 2 0 0 1-2 1.8h-11a2 2 0 0 1-2-1.8z"/><ellipse cx="12" cy="6" rx="9" ry="2.5"/>',
  refresh: '<path d="M21 12a9 9 0 1 1-2.6-6.4"/><path d="M21 3v6h-6"/>',
  key: '<circle cx="8" cy="15" r="4"/><path d="M10.9 12.1 20 3M15 8l3 3M18 5l3 3"/>',
  pause: '<rect x="6" y="4" width="4" height="16" rx="1"/><rect x="14" y="4" width="4" height="16" rx="1"/>',
  play: '<path d="M6 4l14 8-14 8z"/>',
  alert: '<path d="M10.3 3.9 1.8 18a2 2 0 0 0 1.7 3h17a2 2 0 0 0 1.7-3L13.7 3.9a2 2 0 0 0-3.4 0z"/><path d="M12 9v4M12 17h.01"/>',
  globe: '<circle cx="12" cy="12" r="9"/><path d="M3 12h18M12 3c2.4 2.5 3.7 5.7 3.7 9S14.4 18.5 12 21c-2.4-2.5-3.7-5.7-3.7-9S9.6 5.5 12 3z"/>',
